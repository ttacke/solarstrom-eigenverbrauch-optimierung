...
//		const char* network_connection_check_content = "body";
		...
		const float heizung_luftvorwaermer_zuluft_einschalttemperatur = 14.8;
		const float heizung_luftvorwaermer_zuluft_ausschalttemperatur = 15.0;
		const float heizung_luftvorwaermer_abluft_einschalttemperatur = 6.4;
		const float heizung_luftvorwaermer_abluft_ausschalttemperatur = 6.5;
		...
		const int grundverbrauch_in_w_pro_h_sommer = 262;
		const int grundverbrauch_in_w_pro_h_winter = 532;
